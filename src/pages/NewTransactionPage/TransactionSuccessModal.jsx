      ...
      <div className="modal-card">
        <section className="modal-card-body p-6-tablet" style={{ borderRadius: "1em" }}>
          <div className="mb-3 is-flex is-align-items-center is-justify-content-center">
            <i className="material-icons-outlined md-36 mr-3 has-text-success">check_circle_outline</i>
          ...
          <p className="subtitle is-5 has-text-centered">
            Your transaction has been signed and broadcasted to the network. Please wait for a miner to validate and
            confirm the transaction by including it in a block.
          </p>
