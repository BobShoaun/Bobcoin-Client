      ...
      <div className="-has-background-primary has-text-centered" style={{ margin: "5em 0 10em 0" }}>
        ...
        <div className="qualities-grid mx-7-tablet">
          ...
          <div className="-has-background-info has-text-white">
            ...
            <p className="subtitle is-6">Implemented following the nakamoto consensus and bitcoin protocol.</p>
          </div>
        </div>
      </div>
      ...
      <ol className="subtitle is-5 pl-3 px-6-tablet" style={{ marginBottom: "5em" }}>
        <li className="mb-5 is-size-6 is-size-5-tablet">
          <div className="is-flex">
            ...
            <Link to="wallet" className="button is-small is-info ml-auto has-text-weight-semibold px-4">
        ...
        <li className="mb-5 is-size-6 is-size-5-tablet">
          <div className="is-flex">
            ...
            <Link to="mine" className="button is-small is-info ml-auto has-text-weight-semibold px-4">
              <span className="material-icons-outlined md-28">arrow_right_alt</span>
            </Link>
          </div>
        </li>
        ...
        <li className="mb-5 is-size-6 is-size-5-tablet">
          <div className="is-flex">
            <p>
              Host your own node with a copy of the blockchain, and become a valuable peer in the network. (coming soon)
            </p>
          </div>
        </li>
      </ol>
