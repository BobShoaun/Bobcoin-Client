    ...
    <main className="section">
      ...
      <section className="card">
        <div className="card-content params-list">
          ...
          />
          <Parameter _key="version" value={params.version} info="Current protocol version number." />
          <Parameter
            _key="checksumLen"
          ...
          />
          <Parameter _key="derivCoinType" value={params.derivCoinType} info="bip-44 derivation path coin type." />
        </div>
      </section>
    </main>
  );
